export default class CustUp extends CustUpCore {
    ...
    */
    constructor(options: {
        ...
        instance_attach?: CustUp[] | undefined;
    ...
    uiSelect(): void;
    resumeUploaderUI(): void;
    bareUploaderUI(): void;
    detachedUploaderUI(): void;
    profilePictureUI(): void;
}
